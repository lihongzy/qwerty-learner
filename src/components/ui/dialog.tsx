...
function DialogFooter({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div className={clsx('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2', className)} {...props} />
}
...
function DialogTitle({ className, ref, ...props }: DialogTitleProps) {
  return <DialogPrimitive.Title ref={ref} className={clsx('text-lg font-semibold leading-none tracking-tight', className)} {...props} />
}
...
function DialogDescription({ className, ref, ...props }: DialogDescriptionProps) {
  return <DialogPrimitive.Description ref={ref} className={clsx('text-sm text-slate-500 dark:text-slate-400', className)} {...props} />
}
