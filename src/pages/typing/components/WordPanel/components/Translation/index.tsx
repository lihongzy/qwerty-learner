  ...
  return (
    ...
    >
      <div className="flex max-w-4xl items-start justify-center gap-2 px-8">
        <span
          className={`max-w-4xl text-center font-sans leading-[1.7] transition-opacity duration-200 ${showTrans ? 'opacity-100' : 'opacity-0'}`}
              ...
              <TooltipTrigger asChild>
                <span className="inline-flex">
                  <SoundIcon
                    ...
                    ariaLabel="朗读释义"
                    className="text-muted-foreground hover:text-foreground mt-1 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full transition-colors"
                    iconClassName="h-4.5 w-4.5"
                  />
                </span>
              </TooltipTrigger>
              <TooltipContent>朗读释义</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        )}
      </div>
