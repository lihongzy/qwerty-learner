  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center px-4 py-6">
      ...
      <div className="my-panel-strong relative z-10 flex w-full max-w-3xl flex-col overflow-hidden px-5 py-6 sm:px-6">
        <button
          type="button"
          className="my-focus-ring absolute top-4 right-4 inline-flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border-main)] bg-[var(--bg-ghost)] text-[var(--text-muted)] transition-colors duration-150 hover:border-[var(--accent-primary)] hover:text-[var(--text-strong)]"
          onClick={onClose}
        >
