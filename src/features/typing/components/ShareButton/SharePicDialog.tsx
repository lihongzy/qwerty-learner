            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center">
              ...
              >
                <DialogPanel className="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all dark:bg-gray-700">
                  <div className="flex flex-col items-center justify-center pt-20 pr-14 pb-10 pl-20">
                    <button className="absolute top-5 right-7" type="button" onClick={handleClose} title="关闭对话框">
